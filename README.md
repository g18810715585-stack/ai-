...
2. 上传“规划表 Excel”和“配置表 Excel”。
3. 确认“目标配置表名”，例如 `shop_pack_config`。
4. 点击“分析表格”，检查工具识别到的 sheet、表头、隐藏列和合并单元格。
5. 点击“生成草案”，查看“变更 Patch”里的新增/更新/删除建议。
6. 确认 patch 没问题后，点击“生成预览”，工具会生成预览 Excel、diff、校验报告和 rollback patch。
7. 如果这次结果符合你的配表习惯，点击“记录习惯”。
