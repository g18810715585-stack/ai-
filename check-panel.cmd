...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "  $app=$appResp.Content;" ^
  "  $appReady = $app.Contains('serverCommonTables') -and $app.Contains('tablePresetVersion') -and $app.Contains('tableTierLabels') -and $app.Contains('compactRelationshipMap') -and $app.Contains('compactItemResolution') -and $app.Contains('compactDraftDiagnostics') -and $app.Contains('compactConfigPlan') -and $app.Contains('compactExperienceSummary') -and $app.Contains('compactConfigurationRecord') -and $app.Contains('applyCurrentPatch') -and $app.Contains('loadSavedExperiences') -and $app.Contains('setActionBusy') -and $app.Contains('activeProjectId') -and $app.Contains('loadProject') -and $app.Contains('renderProjectStepStatus');" ^
