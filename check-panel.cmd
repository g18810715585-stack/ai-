...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "  $app=$appResp.Content;" ^
  "  $appReady = $app.Contains('serverCommonTables') -and $app.Contains('tablePresetVersion') -and $app.Contains('tableTierLabels') -and $app.Contains('compactRelationshipMap') -and $app.Contains('compactDraftDiagnostics') -and $app.Contains('compactConfigPlan') -and $app.Contains('compactExperienceSummary') -and $app.Contains('loadSavedExperiences') -and $app.Contains('setActionBusy');" ^
  ...
  "  $htmlReady = $html.Contains('targetDialog') -and $html.Contains('experienceDialog') -and $html.Contains('relationsBtn') -and $html.Contains('relationsTab') -and $html.Contains('diagnosticsTab') -and $html.Contains('teachBtn') -and $html.Contains('saveExperienceBtn') -and $html.Contains('openExperienceDialog') -and $html.Contains('experienceSummaryText') -and $html.Contains('activityPlanBtn') -and $html.Contains('planTab') -and $html.Contains('confirmationsTab') -and $html.Contains('internal-manifest') -and ($html.IndexOf('manifest-field') -lt 0);" ^
