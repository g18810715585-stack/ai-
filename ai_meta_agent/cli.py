...
from .patch_sanitizer import apply_reward_top_level_defaults, sanitize_patch
...
def cmd_draft(args: argparse.Namespace) -> int:
    ...
    if args.stub:
        ...
        ai_finished = time.perf_counter()
    reward_defaults = apply_reward_top_level_defaults(patch, schema, context)
    ...
    write_json(run_dir / "reward-defaults.json", reward_defaults)
        ...
        json.dumps(
            {
                ...
                "reward_defaults": str(run_dir / "reward-defaults.json"),
                "context_budget": str(run_dir / "context-budget.json"),
