        ...
        "messages": [
            {
                ...
                "content": (
                    ...
                    "structured_planning is present, treat it as the primary planning evidence: activity_rows drive "
                    "activity fields, shop_groups drive exchange currency/group/sort defaults, and shop_items drive "
                    "active_shop price, purchase limit, sort order, labels, planning quantity, and reward linkage. "
                    ...
                    "Keep the patch minimal: rows and set objects must contain only fields that should be written. "
                    "Do not echo full table rows, do not include schema fields just because they exist, and omit null, "
                    "blank, unknown, unchanged, or placeholder fields. "
                    "For reward rows, only include numbered reward slots that have real evidence. If type_1/reward_1/num_1 "
                    "is the only real reward item, omit type_2/reward_2/num_2 and later unused slots instead of filling "
                    "them with 0. Never use 0 as a placeholder for an unused reward slot unless the planning evidence "
                    "explicitly says that the reward type, content id, or count is 0. "
